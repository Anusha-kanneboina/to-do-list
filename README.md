...
This project focuses on implementing JavaScript logic, DOM manipulation, event handling, local storage, and responsive web design to create a simple and user-friendly task management application.
 ...
 📸 Screenshot
<img width="1561" height="762" alt="to-do-list" src="https://github.com/user-attachments/assets/44468249-194b-4873-829b-10ec8e84177e" />
...
Advanced task sorting options  
User authentication and cloud-based task storage  
...
GitHub: [Anusha-kanneboina](https://github.com/Anusha-kanneboina)
